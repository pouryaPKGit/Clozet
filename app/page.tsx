...
const page = () => {
  ...
  return (
    <div>
      <Banner/>
      <div className="mt-20 w-[95%] mx-auto flex gap-10 bg-[#faebd4] rounded-xl " id="discount-section">
      <OffersPage/>
      <ProductsSlider/>
   </div>
   <ProductBox/>
   ...
   <div className="mt-10 w-[95%] mx-auto flex gap-10 bg-[#faebd4] rounded-xl">
    <MainSlider/>
   </div>
    <Services/>
    </div>
