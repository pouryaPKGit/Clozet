...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="bg-[#faebd4] text-gray-900 flex gap-5 items-center justify-between lg:px-10 px-5 h-[80px] relative">
      <div>
        <CgMenuGridR
          onClick={toggleMenu}
      ...
      {/* منوی موبایل */}
      <div
        className={`fixed top-0 right-0 w-[350px] h-screen bg-[#faebd4] text-white shadow-lg z-50 lg:hidden overflow-y-auto transform transition-transform duration-500 ${
      ...
      >
        ...
        <ul className="flex flex-col mt-5 mr-2 gap-y-4">
          <Link href="/">
            <li
              onClick={closeMenu}
              className="hover:text-gray-500 text-gray-600 bg-[#faebd4] border border-gray-400 rounded-xl flex items-center gap-2 duration-300 font-semibold h-10 ml-3 pr-3 cursor-pointer"
            >
          ...
          <nav  className="hover:text-gray-500 text-gray-600 bg-[#faebd4] border border-gray-400  rounded-xl flex items-center gap-2 duration-300 font-semibold h-10 ml-3 pr-3 cursor-pointer">
            <button onClick={scrollToDiscountSection}>
              <NavLink
                href="#"
                label="تخفیف‌ها"
          ...
          <Link href="/AboutUs">
            <li
              onClick={closeMenu}
              className="hover:text-gray-500 bg-[#faebd4] text-gray-600 border border-gray-400  rounded-xl flex items-center gap-2 duration-300 font-semibold h-10 ml-3 pr-3 cursor-pointer"
            >
          ...
          {user ? (
            <>
              ...
              <Link href="/AccountDetailes">
                <li
                  onClick={closeMenu}
                  className="hover:text-gray-500 bg-[#faebd4] text-gray-600 border border-gray-400  rounded-xl sm:hidden flex items-center gap-1 duration-300 font-semibold h-10 ml-3 pr-3 cursor-pointer"
                >
          ...
          <Link href="/ShoppingCart">
            <li
              onClick={closeMenu}
              className="hover:text-gray-500 bg-[#faebd4] text-gray-600 border border-gray-400  rounded-xl sm:hidden flex items-center gap-2 duration-300 font-semibold h-10 ml-3 pr-3 cursor-pointer"
            >
          ...
          <Link href="/Likes">
            <li
              onClick={closeMenu}
              className="hover:text-gray-500 bg-[#faebd4] text-gray-600 border border-gray-400  rounded-xl sm:hidden flex gap-2 items-center duration-300 font-semibold h-10 ml-3 pr-3 cursor-pointer"
            >
