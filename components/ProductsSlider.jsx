        ...
        {AllBoxes.slice(0,8).map((product) => (
          <SwiperSlide key={product.id}>
            <Link href={`/product/${product.id}`}>
              <div className="bg-[#ffffff] my-2 w-[236px] h-[342px] mx-auto rounded-xl hover:rounded-[40px] hover:opacity-30 duration-500 cursor-pointer">
                ...
                <div className="flex px-3 items-center m-auto text-sm text-black justify-center">
                  <p>{product.name}</p>
                </div>
                <div className="flex justify-between pr-3">
                  ...
                  <div className="pl-3 pt-8">
                    <span className="text-white bg-[#ffe0bf] rounded-xl px-2 py-1 text-sm font-bold">
                      {product.off}%
                    </span>
                  </div>
                </div>
